            ...
            <div className={s2.hw}>
                <div className={s.container}>
                    ...
                    <table id={'hw8-users'} className={s.users}>
                        ...
                        <tr>
                            <td className={s.nameCol + " " + s.colTitle}>Full name</td>
                            <td className={s.ageCol + " " + s.colTitle}>Age</td>
                        </tr>
                        </thead>
